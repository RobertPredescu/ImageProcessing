...
public class MainRotate {
	...
	public static void main(String[] args) {
        ...
        long startTime;
        {System.out.println("ImageRotation");}
        ...
        // in functie de unghiul de rotatie punem o alta cale pentru a putea avea toate exemplele in folder in acelasi timp
        System.out.print("Enter destination path: ");
        String DestinationPath = input.nextLine();
        if(num==90)
        	DestinationPath=DestinationPath+"test90.bmp";
        	myFinalImage = new WriteBMPImage(DestinationPath);
        if(num==180)
        	DestinationPath=DestinationPath+"test180.bmp";
        	myFinalImage = new WriteBMPImage(DestinationPath);
        if(num==270)
        	DestinationPath=DestinationPath+"test270.bmp";
        	myFinalImage = new WriteBMPImage(DestinationPath);
